 ...
 */
final class Version20201003022649 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduled_shift DROP FOREIGN KEY scheduled_shift_user_id_fk');
        $this->addSql('DROP INDEX scheduled_shift_id_uindex ON scheduled_shift');
        $this->addSql('ALTER TABLE scheduled_shift ADD is_approved TINYINT(1) NOT NULL, CHANGE on_duty_id on_duty_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE shift_status shift_status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scheduled_shift DROP is_approved, CHANGE on_duty_id on_duty_id CHAR(36) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\', CHANGE shift_status shift_status TINYTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:simple_array)\'');
