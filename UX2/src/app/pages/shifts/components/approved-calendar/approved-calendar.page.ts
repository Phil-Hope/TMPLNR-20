...
import {ApprovedShiftTitleFormatProvider} from "./shift-title-format.provider";
import {
...
import {ApprovedCustomDateFormatProvider} from "./custom-date-format.provider";
  ...
  providers: [
    {
      ...
      useClass: ApprovedShiftTitleFormatProvider
    },
    {
      provide: CalendarDateFormatter,
      useClass: ApprovedCustomDateFormatProvider
    }
  ],
